...
if vim.g.neovide then
    ...
    -- family, so its Thin/Extended sub-faces can't be picked by guifont alone.
    -- To work around that, custom families were minted from the Extended faces
    -- (see ~/Library/Fonts/IosevkaCustom{ThinExt,Ext}-*.ttf):
    --   "Iosevka Custom ThinExt" -- thin + wide (the light-extended look)
    --   "Iosevka Custom Ext"     -- regular weight + wide
    --   "Iosevka Custom"         -- plain regular (always available fallback)
